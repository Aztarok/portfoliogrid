                    ...
                    <div className=" absolute w-full p-2">
                        ...
                        <div className="">
                            <p className="text-xs font-semibold max-sm:mt-16 sm:mt-4  ">
                                Available for freelance <br /> design projects.
                                Hit me up <br /> for a collab 🦾
                            </p>
                ...
                >
                    ...
                    <div className="mt-14 px-3 pb-3">
                        <p className="text-xs font-semibold   leading-5">
                            Am Joscript Stone, an adventurous Creative Director
                            based in the vibrant city of San Francisco. With a
                            keen eye for aesthetics, a passion for innovation,
                            and a drive for designs that leaves a lasting
                            impact. let's collaborate and bring your creative
                            visions to life
                        </p>
                    </div>
                </motion.div>
                        ...
                        <div className="flex gap-x-3 mt-16 px-2  ">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-neutral-500">
                                    Self-employed at my own creative studio,
                                    delivering innovative design solutions and
                                    giving value to your brand experience.
                                </p>
                            </div>
                        </div>
